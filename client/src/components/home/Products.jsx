...
const Products = () => {
  ...
  const renderProductCard = (product) => (
    <div key={product.id} className="bg-white rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-300 border border-gray-100 h-full">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <span className="font-bold text-lg text-primary">₹{product.price.toLocaleString('en-IN')}</span>
        </div>
        ...
        <Link to={`/products/${product.id}`} className="group/btn">
          <div className="relative overflow-hidden w-full">
            <span className="block text-center bg-primary/90 hover:bg-primary text-white px-4 py-3 rounded-full text-sm font-medium transition-all cursor-pointer shadow-md hover:shadow-xl group-hover/btn:shadow-primary/20">
              View Details
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline-block ml-1 transition-transform duration-300 group-hover/btn:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <div className="inline-flex items-center justify-center gap-2 bg-primary/10 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-primary">Premium Solutions</span>
          </div>
          
          <h2 className="font-montserrat font-bold text-3xl md:text-5xl mb-6">
            Premium <span className="text-primary relative">
          ...
          <p className="text-gray-600 text-lg md:text-xl leading-relaxed">
            Browse our extensive catalog of over 100 specialized building and repair products engineered for lasting performance.
          </p>
        </div>
